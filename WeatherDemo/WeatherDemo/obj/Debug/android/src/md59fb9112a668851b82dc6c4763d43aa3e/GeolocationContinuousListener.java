package md59fb9112a668851b82dc6c4763d43aa3e;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Geolocator.Plugin.GeolocationContinuousListener, Geolocator.Plugin, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener () throws java.lang.Throwable
	{
		...
		if (getClass () == GeolocationContinuousListener.class)
			mono.android.TypeManager.Activate ("Geolocator.Plugin.GeolocationContinuousListener, Geolocator.Plugin, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
